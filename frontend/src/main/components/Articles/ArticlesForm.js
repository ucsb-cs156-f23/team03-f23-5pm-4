...
function ArticlesForm({ initialContents, submitAction, buttonLabel = "Create" }) {
    ...
    const url_regex = /.*\..*/i;
    const email_regex = /[a-zA-Z0-9_\.]+@[a-zA-Z]+\.[a-zA-Z]+/i;
                ...
                <Col>
                    <Form.Group className="mb-3" >
                        ...
                        <Form.Control.Feedback type="invalid">
                            ...
                            {errors.url?.type === 'pattern' && 'URL must be in the format domain.tld, e.g. ucsb.edu'}
                        </Form.Control.Feedback>
                    </Form.Group>
                </Col>
            </Row>
                ...
                <Col>
                    <Form.Group className="mb-3" >
                        ...
                        <Form.Control.Feedback type="invalid">
                            ...
                            {errors.email?.type === 'pattern' && 'Email must be in the format user@domain.tld'}
                        </Form.Control.Feedback>
                    </Form.Group>
                </Col>
            </Row>
