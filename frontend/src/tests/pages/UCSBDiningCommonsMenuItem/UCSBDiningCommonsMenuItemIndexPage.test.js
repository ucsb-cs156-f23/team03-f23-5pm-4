...
describe("UCSBDiningCommonsMenuitemIndexPage tests", () => {
    ...
    test("renders three items correctly for regular user", async () => {
        setupUserOnly();
        axiosMock.onGet("/api/ucsbdiningcommonsmenuitems/all").reply(200, ucsbDiningCommonsMenuItemFixtures.threeItems);
    ...
    test("what happens when you click delete, admin", async () => {
        setupAdminUser();
        axiosMock.onDelete("/api/ucsbdiningcommonsmenuitems").reply(200, "Item with id 1 was deleted");
